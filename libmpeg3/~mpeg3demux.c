...
/*
 * printf("mpeg3_seek_phys 1 %d %d %llx\n", 
 * demuxer->current_title, demuxer->title_cell, demuxer->program_byte);
 */
	result = get_current_cell(demuxer);
/*
 * printf("mpeg3_seek_phys 2 %d %d %llx\n", 
 * demuxer->current_title, demuxer->title_cell, demuxer->program_byte);
 */
