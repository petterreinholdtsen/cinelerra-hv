...
LN_S=ln -sf
STRIP=strip
OPTFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -I/root/hvirtual/quicktime/thirdparty/faad2-2.0//include -std=c99 -fomit-frame-pointer -pthread -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -O3 -fno-math-errno -fno-signed-zeros
VHOOKCFLAGS=-fPIC
...
EXTRALIBS= -L/root/hvirtual/quicktime/thirdparty/faad2-2.0//libfaad/.libs/  -lz -lbz2 -pthread -lm  -lasound -ldl -lasound -lasound
ARCH=x86
ARCH_X86=yes
ARCH_X86_64=yes
HAVE_AMD3DNOW=yes
...
SRC_PATH="/root/hvirtual/quicktime/thirdparty/ffmpeg.030209"
SRC_PATH_BARE=/root/hvirtual/quicktime/thirdparty/ffmpeg.030209
BUILD_ROOT="/root/hvirtual/quicktime/thirdparty/ffmpeg.030209"
