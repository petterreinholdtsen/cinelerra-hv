...
CMakeFiles/package_source:
	tar --transform "s,^,OpenCV-2.3.1/," -cjpf /root/hvirtual/thirdparty/OpenCV-2.3.1/OpenCV-2.3.1.tar.bz2 --exclude=".svn" --exclude="*.pyc" --exclude="*.vcproj" --exclude="*/lib/*" --exclude="*.dll" ./
