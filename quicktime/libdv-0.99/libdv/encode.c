...
// total frames including next one / 
// frame rate * 
// sample rate = 
// total samples including next frame
	total_samples = (int64_t)(frame_count + 1) * 
		(int64_t)frequency * 
		framerate_d / 
		framerate_n;
	samples = total_samples - encoder->total_samples_encoded;
	encoder->total_samples_encoded += samples;
