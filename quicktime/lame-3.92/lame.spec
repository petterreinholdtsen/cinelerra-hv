...
BuildRequires: gcc3, /usr/bin/find, ncurses-devel
Provides: mp3encoder
...
%ifarch i686
	export CC_OPTS="-O3 -fomit-frame-pointer -mcpu=athlon -march=athlon -malign-functions=4 -funroll-loops -fexpensive-optimizations -fschedule-insns2 -Wall -mfancy-math-387 -pipe"
%endif
%ifarch athlon
