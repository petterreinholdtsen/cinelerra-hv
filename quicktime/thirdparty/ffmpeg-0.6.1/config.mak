...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-pthreads --enable-gpl --disable-ffplay --extra-cflags=-I/root/hvirtual/quicktime/thirdparty/faad2-2.7//include --extra-libs=-L/root/hvirtual/quicktime/thirdparty/faad2-2.7//libfaad/.libs/ --disable-ffserver --disable-ffplay
prefix=/usr/local
...
CFLAGS= -I/root/hvirtual/quicktime/thirdparty/faad2-2.7//include  -std=c99 -fomit-frame-pointer -pthread -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes
ASFLAGS= -I/root/hvirtual/quicktime/thirdparty/faad2-2.7//include  -g
CC_O=-o $@
...
EXTRALIBS= -L/root/hvirtual/quicktime/thirdparty/faad2-2.7//libfaad/.libs/  -lz -lbz2 -pthread -lm -lasound -lasound -lasound
INSTALL=install
LIBTARGET=
