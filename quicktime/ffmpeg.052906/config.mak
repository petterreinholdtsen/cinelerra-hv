...
STRIP=strip
INSTALLSTRIP=-s
OPTFLAGS=-O3 -g -Wall -Wno-switch  -I/root/hvirtual/quicktime/thirdparty/faad2-2.0//include -Wdeclaration-after-statement
SHCFLAGS=-O3 -g -Wall -Wno-switch  -I/root/hvirtual/quicktime/thirdparty/faad2-2.0//include -Wdeclaration-after-statement
LDFLAGS=-Wl,--warn-common -rdynamic -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavutil 
LDCONFIG=ldconfig
FFSLDFLAGS=-Wl,-E
...
BUILD_VHOOK=yes
EXTRALIBS=-L/root/hvirtual/quicktime/thirdparty/faad2-2.0//libfaad/.libs/ -lz -ldl -lpthread
VERSION=CVS
CONFIG_ENCODERS=yes
CONFIG_DECODERS=yes
CONFIG_MUXERS=yes
...
CONFIG_GPL=yes
SRC_PATH=/root/hvirtual/quicktime/thirdparty/ffmpeg.052906
BUILD_ROOT=/root/hvirtual/quicktime/thirdparty/ffmpeg.052906
