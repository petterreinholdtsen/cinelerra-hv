...
SET(OpenCV_INCLUDE_DIRS "/root/hvirtual/thirdparty/OpenCV-2.3.1" "/root/hvirtual/thirdparty/OpenCV-2.3.1/include" "/root/hvirtual/thirdparty/OpenCV-2.3.1/include/opencv")
...
SET(OpenCV_LIB_DIR /root/hvirtual/thirdparty/OpenCV-2.3.1/lib)
...
# ==============================================================
if(NOT "/root/hvirtual/thirdparty/OpenCV-2.3.1" STREQUAL  "")
    foreach(__CVLIB ${OpenCV_LIB_COMPONENTS})
        # We only need the "core",... part here: "opencv_core" -> "core"
        STRING(REGEX REPLACE "opencv_(.*)" "\\1" __MODNAME ${__CVLIB})
        INCLUDE_DIRECTORIES("/root/hvirtual/thirdparty/OpenCV-2.3.1/modules/${__MODNAME}/include")
    endforeach()
endif()
...
IF (NOT OpenCV_SHARED)
    ...
    LINK_DIRECTORIES("/root/hvirtual/thirdparty/OpenCV-2.3.1/3rdparty/lib")

    set(OpenCV_LIBS dl;m;pthread;rt   ${OpenCV_LIBS})
    set(OpenCV_EXTRA_COMPONENTS /usr/lib64/libjpeg.so /usr/lib64/libpng.so;/usr/lib64/libz.so libtiff libjasper /usr/lib64/libz.so)
